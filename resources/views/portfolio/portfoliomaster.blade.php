				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="#">Ecovani</a></div>
						</div>
					</div>
				...
				@endforeach
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									<li><a href={{route('portfolio')}}>Portfolio<i class="fas fa-chevron-down"></i></a></li>
									<li class="hassubs">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="blog.html">cart<i class="fas fa-chevron-down"></i></a></li>
