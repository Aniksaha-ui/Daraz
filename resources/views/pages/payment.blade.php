...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;"> 
    ...
    <div class="form-group">
        <ul class="logos_list">
              ...
              <li><input type="radio" name="payment" value="stripe"><img src="{{asset('fontend/images/stripe.png')}}" style="width: 100px;height: 60px;"></li>
          
              <li><input type="radio" name="payment" value="paypal"><img src="{{asset('fontend/images/stripe.png')}}" style="width: 100px;height: 60px;"></li>

                 <li><input type="radio" name="payment" value="cashondelivery"><img src="{{asset('fontend/images/cashondelivery.png')}}" style="width: 100px;height: 60px;"></li>
