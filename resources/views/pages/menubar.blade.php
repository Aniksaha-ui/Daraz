                       ...
                       <div class="menu_contact">
                           <div class="menu_contact_item">
                               <div class="menu_contact_icon"><img
                                       src="{{ asset('public/frontend/images/phone_white.png') }}" alt="">
                               </div>01628781323
                           </div>
                           <div class="menu_contact_item">
                               <div class="menu_contact_icon"><img
                                       src="{{ asset('public/frontend/images/mail_white.png') }}" alt="">
                               </div><a href="mailto:sahaanik1045@gmail.com">sahaanik1045@gmail.com</a>
                           </div>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-lg-5 offset-lg-4 fill_height">
                   <div class="banner_content">
                       ...
                       <div class="button banner_button"><a
                               href="{{ url('product/details/' . $slider->id . '/' . $slider->product_name) }}">Show
                               Details</a></div>
                   </div>
               </div>
           </div>
