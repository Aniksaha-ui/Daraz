...
@include('pages.menubar')
    ...
    @php 
        ...
        $best_rated=DB::table('products')->where('status',1)->where('best_rated',1)->orderBy('id','desc')->limit(20)->get();
        $hot=DB::table('products')
             ->join('brands','products.brand_id','brands.id')
             ->where('products.status',1)->where('products.hot_deal',1)
        ...
        $hot_new=DB::table('products')
                 ->where('products.status',1)->where('products.hot_new',1)
                 ->orderBy('products.id','desc')
                 ->limit(20)
                 ->get();
                                ...
                                @foreach($feature as $row)
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><a href="{{url('product/details/'.$row->id.'/'.$row->product_name)}}"><img src="{{asset($row->image_one)}}" style="height: 120px; width: 140px;" alt=""></a></div>
                                            <div class="product_content">

                                                @if($row->discount_price == NULL)
                                                    <div class="product_price">${{$row->selling_price}}</div>
                                                @else
                                                    <div class="product_price">${{$row->selling_price}}<span>${{$row->discount_price}}</span></div>
                                                @endif
                        ...
                        <div class="owl-carousel owl-theme popular_categories_slider">
                            ...
                            <div class="owl-item">
                                <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                    <div class="popular_category_image"><img src="{{asset('fontend/images/popular_1.png')}}" alt=""></div>
    ...
    <div class="banner_2">
        <div class="banner_2_background" style="background-image:url({{asset('fontend/images/banner_2_background.jpg')}}"></div>
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        <div class="banner_2_category"><h4>{{$mid->category_name}}</h4></div>
                                        <div class="banner_2_title">{{$mid->product_name}}</div>
                                        <div class="banner_2_text"><h4>{{$mid->brand_name}}</h4> <br> {{$row->selling_price}} </div>
                                        <div class="rating_r rating_r_4 banner_2_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                        <div class="button banner_2_button"><a href="{{url('product/details/'.$mid->id.'/'.$mid->product_name)}}">Explore</a></div>
                                    </div>
                                    
                                </div>
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="{{asset($mid->image_one)}}" alt="" style="height: 400px;
                                        width: 350px;"></div>
                                    </div>
                                </div>
                            </div>
...
<div class="product_price discount">${{ $row->discount_price }}<span>${{ $row->selling_price }}</span></div>
      @endif
                ...
                <div class="product_extras">
                     ...
                     <button  class="product_cart_button addcart1" data-id="{{$row->id}}" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add to Cart</button>
                </div>
            </div>
...
<div class="product_price discount">${{ $row->discount_price }}<span>${{ $row->selling_price }}</span></div>
      @endif
                ...
                <div class="product_extras">
                    ...
                    <button  class="product_cart_button addcart1" data-id="{{$row->id}}">Add to Cart</button>
                </div>
            </div>
                                    ...
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="bestsellers_content">
                                         ...
                                         <div class="bestsellers_price discount">${{$row->discount_price}}<span>${{$row->selling_price}}</span></div>
                                          @else
                                           <div class="bestsellers_price discount">${{$row->selling_price}}</div>
                ...
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        <div class="advert_content">
                            <div class="advert_title"><a href="{{url('product/details/'.$row->id.'/'.$row->product_name)}}">Trends 2021</a></div>
                            <div class="advert_text">{{$row->product_name}}
                            </div>
                            
                        </div>
                        <div class="ml-auto"><div class="advert_image"><img src="{{asset($row->image_one)}}" height="50%" width="40%" alt=""></div></div>
                    </div>
