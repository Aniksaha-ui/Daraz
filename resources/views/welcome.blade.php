...
<link href="{{asset('fontend/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{asset('fontend/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('fontend/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('fontend/images/phone.png')}}" alt=""></div>+38 068 005 3570</div>
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('fontend/images/mail.png')}}" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
                        <div class="top_bar_content ml-auto">
                            ...
                            <div class="top_bar_menu">
                                ...
                                @else
                                 <a href="{{ route('language.hindi') }}">Bangla<i class="fas fa-chevron-down"></i></a>
                                @endif        
                            ...
                            <div class="top_bar_user">
                                ...
                                @guest
                                 <div><a href="{{route('login')}}"> <div class="user_icon"><img src="{{asset('fontend/images/user.svg')}}" alt=""></div>Sign in</a></div>
                                @else
                                  <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                        <a href="{{route('home')}}">Profile<div class="user_icon"><img src="{{asset('fontend/images/user.svg')}}" alt=""></div><i class="fas fa-chevron-down"></i></a>
                                        <ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        <div class="logos ml-sm-auto">
                            <ul class="logos_list">
                                <li><a href="#"><img src="{{asset('fontend/images/logos_1.png')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('fontend/images/logos_2.png')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('fontend/images/logos_3.png')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('fontend/images/logos_4.png')}}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
