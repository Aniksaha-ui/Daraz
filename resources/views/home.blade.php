...
@else
    ...
    @endif -->
                ...
                <div class="col-4">
                    <div class="card">
                        <img src="https://media.licdn.com/dms/image/v2/C5603AQH1nv6-4TfTwQ/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1659895844147?e=1744243200&v=beta&t=FGYF6MWUZdvmL5A7m2-kyZJh4_BBc93N7-nst7i9Y9U"
                            class="card-img-top" style="height: 90px; width: 90px; margin-left: 34%;">
                        <div class="card-body">
