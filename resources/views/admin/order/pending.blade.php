          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  <td style="color: black">{{$row->payment_type}}</td>
                  <td style="color: black">{{ $row->blnc_transection }}</td>
                  <td style="color: black">{{ $row->subtotal }} </td>
                  <td style="color: black">{{ $row->shipping }} </td>
