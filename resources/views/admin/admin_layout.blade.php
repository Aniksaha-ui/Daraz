...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{route('Home')}}"><i class="icon ion-android-star-outline"></i>XIXOTECH</a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('admin.accept.payment')}}" class="nav-link">Accept Payment</a></li>
           <li class="nav-item"><a href="{{route('admin.cancel.payment')}}" class="nav-link">Cancle Order</a></li>
            <li class="nav-item"><a href="{{route('admin.process.payment')}}" class="nav-link">Process Order</a></li>
             <li class="nav-item"><a href="{{route('admin.success.payment')}}" class="nav-link">Delivered Orders</a></li>
