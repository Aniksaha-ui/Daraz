...
<body>
    ...
    @else
        <!-- ########## START: LEFT PANEL ########## -->
        <div class="sl-logo"><a href="{{ route('Home') }}"><i class="icon ion-android-star-outline"></i>Ecovani </a></div>
        <div class="sl-sideleft">
            ...
            <div class="sl-sideleft-menu">
                ...
                <ul class="sl-menu-sub nav flex-column">
                    ...
                    <li class="nav-item"><a href="{{ route('today.delivery') }}" class="nav-link">Today's Delivery</a>
                    </li>
                ...
                <ul class="sl-menu-sub nav flex-column">
                    ...
                    <li class="nav-item"><a href="{{ route('admin.accept.payment') }}" class="nav-link">Accept
                            Payment</a></li>
                    <li class="nav-item"><a href="{{ route('admin.cancel.payment') }}" class="nav-link">Cancle Order</a>
                    </li>
                    <li class="nav-item"><a href="{{ route('admin.process.payment') }}" class="nav-link">Process
                            Order</a></li>
