 ...
 <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5 style="text-align: center";>Coupon Table</h5>
         
        </div><!-- sl-page-title -->

        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title" style="text-align: center;">Coupon List
       <a href="#" class="btn btn-sm btn-warning" style="float: right;" data-toggle="modal" data-target="#modaldemo3">New Coupon</a>
          </h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family:Arial;color: black;">{{ $row->coupon }}</td>
                  <td style="font-family:Arial;color: black;">{{ $row->discount }}</td> 
                  <td>
      ...
      @endif
       <form method="post" action="{{ route('store.coupon') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Discoun Amount" name="discount">
