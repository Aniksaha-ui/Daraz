 ...
 <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5 style="text-align: center";>Subscriber Information</h5>
         
        </div><!-- sl-page-title -->

        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title" style="text-align: center;">Subscriber List
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family:Arial;color: black;">{{ \Carbon\Carbon::parse($row->created_at)->diffForhumans()  }}</td>
                  <td>
